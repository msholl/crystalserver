...
--
-- Rates do CoxaOT. Exige rateUseStages = true no config.lua, senao o servidor
-- ignora este arquivo e usa os rateExp/rateSkill/rateMagic fixos.
...
-- A tabela pedida comeca em 1, mas os personagens nascem com skill 10 e o
-- arquivo original comecava em 10. Deixo minlevel = 1 para nao existir faixa
-- descoberta caso algo consulte skill abaixo de 10.
skillsStages = {
